...
export function GoogleSignInButton({
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={isLoading}
      className="flex w-full items-center justify-center gap-2 rounded-md border border-navy-100 bg-white px-4 py-2 text-sm font-medium text-navy-900 hover:bg-navy-50 disabled:opacity-50"
    >
      <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.3 0 10.1-2 13.7-5.3l-6.3-5.3C29.4 35.1 26.8 36 24 36c-5.3 0-9.6-3.4-11.3-8.1l-6.5 5C9.6 39.7 16.3 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.2 5.7l6.3 5.3C40.5 36.5 44 30.9 44 24c0-1.3-.1-2.7-.4-3.5z"
        />
      </svg>
      {label}
    </button>
